...
PHP_METHOD(Phalcon_Http_Cookie, send) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 219, name, encryptValue, expire, path, domain, secure, httpOnly);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Http_Cookie, delete) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 219, name, ZEPHIR_GLOBAL(global_null), &_5, path, domain, secure, httpOnly);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
