...
PHP_METHOD(Phalcon_Http_Request, get) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 220, _REQUEST, name, filters, defaultValue, _0, _1);
...
PHP_METHOD(Phalcon_Http_Request, getPost) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 220, _POST, name, filters, defaultValue, _0, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getPut) {
	...
	if (Z_TYPE_P(put) != IS_ARRAY) {
		...
		zephir_check_call_status();
		ZEPHIR_MAKE_REF(put);
		ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 221, _0$$3, put);
		ZEPHIR_UNREF(put);
		zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 220, put, name, filters, defaultValue, _1, _2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getQuery) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 220, _GET, name, filters, defaultValue, _0, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getServerAddress) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("gethostbyname", NULL, 222, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, isMethod) {
	...
	ZEPHIR_CALL_METHOD(&httpMethod, this_ptr, "getmethod", NULL, 223);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isPost) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getmethod", NULL, 223);
	zephir_check_call_status();
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_array_isset_string_fetch(&error, file, SS("error"), 0 TSRMLS_CC)) {
			...
			if (Z_TYPE_P(error) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&_4$$8, this_ptr, "hasfilehelper", &_6, 224, error, _5$$8);
				zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (Z_TYPE_P(value) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&_4$$7, this_ptr, "hasfilehelper", &_6, 224, value, _5$$7);
			zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_1$$3, &_0$$3)
			...
			if (Z_TYPE_P(_3$$4) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_9, 225, _4$$5, _5$$5, _6$$5, _7$$5, _8$$5, prefix);
				zephir_check_call_status();
				...
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_11$$5, &_10$$5)
					...
					if (_13$$6) {
						...
						ZEPHIR_CALL_METHOD(NULL, _16$$7, "__construct", &_18, 226, dataFile, _17$$7);
						zephir_check_call_status();
				...
				if (_19$$8) {
					...
					ZEPHIR_CALL_METHOD(NULL, _21$$9, "__construct", &_18, 226, input, prefix);
					zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (Z_TYPE_P(name) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_10, 225, _5$$5, _6$$5, _7$$5, _8$$5, _9$$5, p);
			zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_start_with_str(name, SL("HTTP_"))) {
			...
			ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_9, 227, _3$$4);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_9, 227, _13$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, _getQualityHeader) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&_4, "preg_split", &_5, 228, &_1, _0, &_2, &_3);
	zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_7, &_6)
		...
		ZVAL_LONG(&_12$$3, 1);
		ZEPHIR_CALL_FUNCTION(&_13$$3, "preg_split", &_5, 228, &_10$$3, _9$$3, &_11$$3, &_12$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getAcceptableContent) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualityheader", NULL, 229, _0, _1);
	zephir_check_temp_parameter(_0);
...
PHP_METHOD(Phalcon_Http_Request, getBestAccept) {
	...
	ZEPHIR_INIT_VAR(_1);
	ZVAL_STRING(_1, "accept", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getbestquality", NULL, 230, _0, _1);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	RETURN_MM();
