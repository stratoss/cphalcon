...
PHP_METHOD(Phalcon_Cli_Console, setArgument) {
	...
	if (_0) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "array_shift", &_1, 124, arguments);
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		if (Z_TYPE_P(arg) == IS_STRING) {
			...
			ZVAL_LONG(&_6$$5, 2);
			ZEPHIR_CALL_FUNCTION(&_7$$5, "strncmp", &_8, 125, arg, &_5$$5, &_6$$5);
			zephir_check_call_status();
			if (ZEPHIR_IS_LONG(_7$$5, 0)) {
				...
				ZVAL_LONG(&_21$$9, 1);
				ZEPHIR_CALL_FUNCTION(&_22$$9, "strncmp", &_8, 125, arg, &_20$$9, &_21$$9);
				zephir_check_call_status();
	...
	if (str) {
		...
		ZEPHIR_CALL_CE_STATIC(&_26$$13, phalcon_cli_router_route_ce, "getdelimiter", &_27, 126);
		zephir_check_call_status();
		...
		if (zephir_fast_count_int(args TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_28$$15, "array_shift", &_1, 124, args);
			ZEPHIR_UNREF(args);
			zephir_check_call_status();
		...
		if (zephir_fast_count_int(args TSRMLS_CC)) {
			ZEPHIR_MAKE_REF(args);
			ZEPHIR_CALL_FUNCTION(&_29$$16, "array_shift", &_1, 124, args);
			ZEPHIR_UNREF(args);
			zephir_check_call_status();
