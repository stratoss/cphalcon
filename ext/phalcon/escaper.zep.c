...
PHP_METHOD(Phalcon_Escaper, detectEncoding) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		ZEPHIR_CALL_FUNCTION(&_5$$5, "mb_detect_encoding", &_6, 181, str, charset, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
		if (zephir_is_true(_5$$5)) {
			RETURN_CCTOR(charset);
		}
	}
	ZEPHIR_RETURN_CALL_FUNCTION("mb_detect_encoding", &_6, 181, str);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, normalizeEncoding) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "detectencoding", NULL, 182, str);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_STRING(&_1, "UTF-32", 0);
	ZEPHIR_RETURN_CALL_FUNCTION("mb_convert_encoding", NULL, 183, str, &_1, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, escapeHtml) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars", NULL, 184, text, _0, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, escapeHtmlAttr) {
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, 3);
	ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars", NULL, 184, attribute, &_1, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, escapeCss) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "normalizeencoding", NULL, 185, css);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Escaper, escapeJs) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "normalizeencoding", NULL, 185, js);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Escaper, escapeUrl) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 186, url);
	zephir_check_call_status();
	RETURN_MM();
