...
PHP_METHOD(Phalcon_Forms_Element_Select, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_forms_element_select_ce, this_ptr, "__construct", &_0, 208, name, attributes);
...
PHP_METHOD(Phalcon_Forms_Element_Select, render) {
	...
	ZEPHIR_RETURN_CALL_CE_STATIC(phalcon_tag_select_ce, "selectfield", &_0, 209, _1, _2);
	zephir_check_call_status();
	RETURN_MM();
