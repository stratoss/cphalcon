...
PHP_METHOD(Phalcon_Logger_Formatter_Firephp, format) {
	...
	if (zephir_is_true(_3)) {
		...
		ZVAL_STRING(&_6$$4, "<", 0);
		ZEPHIR_CALL_FUNCTION(&_7$$4, "version_compare", NULL, 242, _4$$4, &_5$$4, &_6$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&backtrace, "debug_backtrace", NULL, 154, &_5$$4);
		zephir_check_call_status();
		ZEPHIR_MAKE_REF(backtrace);
		ZEPHIR_CALL_FUNCTION(&lastTrace, "end", NULL, 173, backtrace);
