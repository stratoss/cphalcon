...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, get) {
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "_getcollection", NULL, 111);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, save) {
	...
	ZEPHIR_CALL_METHOD(&collection, this_ptr, "_getcollection", NULL, 111);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_0);
	zephir_time(_0);
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, delete) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "_getcollection", NULL, 111);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_1);
	zephir_create_array(_1, 1, 0 TSRMLS_CC);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "rand", NULL, 112);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, exists) {
	...
	if (zephir_is_true(lastKey)) {
		ZEPHIR_CALL_METHOD(&_1$$5, this_ptr, "_getcollection", NULL, 111);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_Mongo, increment) {
	...
	ZEPHIR_CONCAT_VV(prefixedKey, _0, keyName);
	zephir_update_property_this(this_ptr, SL("_lastKey"), prefixedKey TSRMLS_CC);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "_getcollection", NULL, 111);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_2);
	zephir_create_array(_2, 1, 0 TSRMLS_CC);
