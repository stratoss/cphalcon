...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 231, &_2);
	zephir_check_call_status();
	if (zephir_is_true(_3)) {
		ZEPHIR_SINIT_VAR(_4$$5);
		ZVAL_STRING(&_4$$5, "Imagick::IMAGICK_EXTNUM", 0);
		ZEPHIR_CALL_FUNCTION(&_5$$5, "constant", NULL, 193, &_4$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct) {
	...
	if ((zephir_file_exists(_2 TSRMLS_CC) == SUCCESS)) {
		...
		if (!(zephir_is_true(_12$$4))) {
			...
			ZEPHIR_CALL_FUNCTION(&_15$$6, "constant", NULL, 193, &_14$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _reflection) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$7, "constant", &_21, 193, &_19$$7);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_21, 193, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::CHANNEL_ALPHA", 0);
		ZEPHIR_CALL_FUNCTION(&_26$$7, "constant", &_21, 193, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_22$$7);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_37$$10, "constant", &_21, 193, &_36$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_46$$10, "constant", &_21, 193, &_36$$10);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_34$$10);
		ZVAL_LONG(_34$$10, 0);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_52$$13, "constant", &_21, 193, &_51$$13);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _watermark) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "constant", &_6, 193, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_7$$3);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _text) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, b);
	ZEPHIR_CALL_FUNCTION(&color, "sprintf", NULL, 190, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_4);
			...
			if (Z_TYPE_P(offsetY) == IS_LONG) {
				...
				if (zephir_is_true(offsetX)) {
					...
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_13$$17);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_SINIT_VAR(_14$$18);
						ZVAL_STRING(&_14$$18, "Imagick::GRAVITY_NORTHEAST", 0);
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_14$$18);
						zephir_check_call_status();
					}
				} else {
					ZEPHIR_INIT_NVAR(offsetX);
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_15$$20);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_SINIT_VAR(_16$$21);
						ZVAL_STRING(&_16$$21, "Imagick::GRAVITY_NORTH", 0);
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_16$$21);
						zephir_check_call_status();
					}
				}
			}
				...
				if (Z_TYPE_P(offsetY) == IS_BOOL) {
					if (zephir_is_true(offsetY)) {
						...
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_17$$27);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_SINIT_VAR(_18$$28);
							ZVAL_STRING(&_18$$28, "Imagick::GRAVITY_SOUTH", 0);
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_18$$28);
							zephir_check_call_status();
						}
					} else {
						ZEPHIR_INIT_NVAR(offsetY);
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_19$$30);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_SINIT_VAR(_20$$31);
							ZVAL_STRING(&_20$$31, "Imagick::GRAVITY_WEST", 0);
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_20$$31);
							zephir_check_call_status();
						}
					}
				} else {
					if (Z_TYPE_P(offsetY) == IS_LONG) {
						...
						if (x < 0) {
							...
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_21$$35);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, (x * -1));
								ZEPHIR_SINIT_VAR(_22$$36);
								ZVAL_STRING(&_22$$36, "Imagick::GRAVITY_NORTHEAST", 0);
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_22$$36);
								zephir_check_call_status();
							}
						} else {
							ZEPHIR_INIT_NVAR(offsetX);
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_23$$38);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, 0);
								ZEPHIR_SINIT_VAR(_24$$39);
								ZVAL_STRING(&_24$$39, "Imagick::GRAVITY_NORTHWEST", 0);
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 193, &_24$$39);
								zephir_check_call_status();
							}
						}
					}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _mask) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_7$$3, "constant", &_8, 193, &_6$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_4$$3);
		ZVAL_LONG(_4$$3, 0);
		...
		zephir_check_call_status();
		if (!ZEPHIR_IS_TRUE_IDENTICAL(ret)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/image/adapter/imagick.zep", 529);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _background) {
	...
	while (1) {
		...
		if (!(zephir_is_true(_9$$3))) {
			...
			ZEPHIR_CALL_FUNCTION(&_12$$4, "constant", &_13, 193, &_11$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_17$$3, "constant", &_13, 193, &_16$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_16$$3);
		ZVAL_STRING(&_16$$3, "Imagick::CHANNEL_ALPHA", 0);
		ZEPHIR_CALL_FUNCTION(&_18$$3, "constant", &_13, 193, &_16$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_25$$3, "constant", &_13, 193, &_16$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_19$$3);
		ZVAL_LONG(_19$$3, 0);
		...
		zephir_check_call_status();
		if (!ZEPHIR_IS_TRUE_IDENTICAL(ret)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/image/adapter/imagick.zep", 568);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _save) {
	...
	if (ZEPHIR_IS_LONG(_8, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 287, file, &_11$$3);
		zephir_check_call_status();
		...
		if (_15$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_19$$5, "constant", NULL, 193, &_18$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _render) {
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(_4, 0)) {
		...
		if (_8$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_11$$5, "constant", NULL, 193, &_10$$5);
			zephir_check_call_status();
