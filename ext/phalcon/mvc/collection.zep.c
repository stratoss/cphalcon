...
PHP_METHOD(Phalcon_Mvc_Collection, _getResultset) {
	...
	ZEPHIR_CALL_FUNCTION(&_5, "iterator_to_array", NULL, 296, documentsCursor);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Collection, save) {
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "_presave", NULL, 297, dependencyInjector, disableEvents, exists);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_postsave", NULL, 298, disableEvents, _5, exists);
	zephir_check_call_status();
	RETURN_MM();
