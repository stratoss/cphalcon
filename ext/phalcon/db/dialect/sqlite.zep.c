			...
			if (Z_TYPE_P(typeValues) == IS_ARRAY) {
				...
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_11$$25, &_10$$25)
					...
					ZEPHIR_CALL_FUNCTION(&_14$$26, "addcslashes", &_15, 145, value$$25, &_13$$26);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_22$$27, "addcslashes", &_15, 145, typeValues, &_21$$27);
				zephir_check_call_status();
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_is_true(_10$$7)) {
			...
			if (zephir_memnstr_str(_11$$10, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 309)) {
				...
				ZEPHIR_CALL_FUNCTION(&_13$$12, "addcslashes", &_14, 145, defaultValue, &_12$$12);
				zephir_check_call_status();
