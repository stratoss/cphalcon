...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, viewExists) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 146, viewName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 146, schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 146, viewName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, listViews) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 146, schemaName);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, tableExists) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 146, tableName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 146, schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 146, tableName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeColumns) {
	...
	if (!ZEPHIR_IS_STRING(schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 146, table);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 146, schema);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 146, table);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeReferences) {
	...
	if (!ZEPHIR_IS_STRING(schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 146, schema);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 146, table);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_3$$3);
		ZEPHIR_CONCAT_SVSVS(_3$$3, "AND AC.OWNER='", _0$$3, "' AND AC.TABLE_NAME = '", _2$$3, "'");
		zephir_concat_self(&sql, _3$$3 TSRMLS_CC);
	} else {
		ZEPHIR_CALL_CE_STATIC(&_4$$4, phalcon_text_ce, "upper", &_1, 146, table);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, prepareTable) {
	...
	ZEPHIR_CALL_CE_STATIC(&_1, phalcon_text_ce, "upper", &_2, 146, table);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_2, 146, schema);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_PARENT(phalcon_db_dialect_oracle_ce, this_ptr, "preparetable", &_0, 147, _1, _3, alias, escapeChar);
	zephir_check_call_status();
	RETURN_MM();
