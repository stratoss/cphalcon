			...
			if (Z_TYPE_P(typeValues) == IS_ARRAY) {
				...
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_24$$51, &_23$$51)
					...
					ZEPHIR_CALL_FUNCTION(&_27$$52, "addcslashes", &_28, 145, value$$51, &_26$$52);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_35$$53, "addcslashes", &_28, 145, typeValues, &_34$$53);
				zephir_check_call_status();
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_is_true(_6$$7)) {
			...
			if (zephir_memnstr_str(_7$$8, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/mysql.zep", 414)) {
				...
				ZVAL_STRING(&_8$$10, "\"", 0);
				ZEPHIR_CALL_FUNCTION(&_9$$10, "addcslashes", &_10, 145, defaultValue, &_8$$10);
				zephir_check_call_status();
