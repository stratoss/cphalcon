...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, connect) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_db_adapter_pdo_sqlite_ce, this_ptr, "connect", &_0, 144, descriptor);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeColumns) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_5, &_4)
		...
		ZEPHIR_CALL_METHOD(NULL, _43$$3, "__construct", &_44, 143, columnName, definition);
		zephir_check_call_status();
