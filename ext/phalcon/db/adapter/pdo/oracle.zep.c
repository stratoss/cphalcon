...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Oracle, connect) {
	...
	ZEPHIR_CALL_PARENT(&status, phalcon_db_adapter_pdo_oracle_ce, this_ptr, "connect", &_0, 144, descriptor);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Oracle, describeColumns) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_5, &_4)
		...
		ZEPHIR_CALL_METHOD(NULL, _23$$3, "__construct", &_24, 143, columnName, definition);
		zephir_check_call_status();
