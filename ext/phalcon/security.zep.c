...
PHP_METHOD(Phalcon_Security, getSaltBytes) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$5, "base64_encode", &_5, 117, _2$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, hash) {
	...
	do {
		...
		if (hash == 8) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 403, password, _5$$11);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		ZEPHIR_CALL_FUNCTION(&_10$$13, "sprintf", NULL, 190, &_8$$13, &_9$$13);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_11$$13);
		ZEPHIR_CONCAT_SVSVSV(_11$$13, "$2", variant, "$", _10$$13, "$", saltBytes);
		ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 403, password, _11$$13);
		zephir_check_call_status();
		RETURN_MM();
	} while(0);
...
PHP_METHOD(Phalcon_Security, getTokenKey) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_3, "base64_encode", NULL, 117, _2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getToken) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "base64_encode", NULL, 117, token);
	zephir_check_call_status();
