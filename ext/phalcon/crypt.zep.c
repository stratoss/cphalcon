	...
	if (_0) {
		...
		do {
			if (paddingType == 1) {
				...
				ZVAL_LONG(&_1$$5, 0);
				ZEPHIR_CALL_FUNCTION(&_2$$5, "chr", &_3, 133, &_1$$5);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_1$$5);
				ZVAL_LONG(&_1$$5, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_4$$5, "str_repeat", &_5, 134, _2$$5, &_1$$5);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_1$$5);
				ZVAL_LONG(&_1$$5, paddingSize);
				ZEPHIR_CALL_FUNCTION(&_6$$5, "chr", &_3, 133, &_1$$5);
				zephir_check_call_status();
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_8$$6, "chr", &_3, 133, &_7$$6);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_7$$6);
				ZVAL_LONG(&_7$$6, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 134, _8$$6, &_7$$6);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 3) {
				...
				if (_10$$7 <= _11$$7) {
					while (1) {
						...
						i = _10$$7;
						ZEPHIR_CALL_FUNCTION(&_12$$8, "rand", &_13, 112);
						zephir_check_call_status();
						ZEPHIR_CALL_FUNCTION(&_14$$8, "chr", &_3, 133, _12$$8);
						zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_16$$7, "chr", &_3, 133, &_15$$7);
				zephir_check_call_status();
			...
			if (paddingType == 4) {
				...
				ZEPHIR_CALL_FUNCTION(&_18$$9, "chr", &_3, 133, &_17$$9);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_17$$9);
				ZVAL_LONG(&_17$$9, 0);
				ZEPHIR_CALL_FUNCTION(&_19$$9, "chr", &_3, 133, &_17$$9);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_17$$9);
				ZVAL_LONG(&_17$$9, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_20$$9, "str_repeat", &_5, 134, _19$$9, &_17$$9);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(padding);
			...
			if (paddingType == 5) {
				...
				ZVAL_LONG(&_21$$10, 0);
				ZEPHIR_CALL_FUNCTION(&_22$$10, "chr", &_3, 133, &_21$$10);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_21$$10);
				ZVAL_LONG(&_21$$10, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 134, _22$$10, &_21$$10);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 6) {
				...
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 134, &_23$$11, &_24$$11);
				zephir_check_call_status();
				break;
			}
			paddingSize = 0;
	...
	if (_1) {
		do {
			if (paddingType == 1) {
				...
				ZEPHIR_CALL_FUNCTION(&_5$$4, "ord", &_6, 135, last);
				zephir_check_call_status();
				...
				if (ord <= blockSize) {
					...
					ZVAL_LONG(&_7$$5, 0);
					ZEPHIR_CALL_FUNCTION(&_8$$5, "chr", &_9, 133, &_7$$5);
					zephir_check_call_status();
					ZEPHIR_SINIT_NVAR(_7$$5);
					ZVAL_LONG(&_7$$5, (paddingSize - 1));
					ZEPHIR_CALL_FUNCTION(&_10$$5, "str_repeat", &_11, 134, _8$$5, &_7$$5);
					zephir_check_call_status();
					ZEPHIR_INIT_VAR(padding);
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_15$$7, "ord", &_6, 135, last);
				zephir_check_call_status();
				...
				if (ord <= blockSize) {
					...
					ZEPHIR_CALL_FUNCTION(&_17$$8, "chr", &_9, 133, &_16$$8);
					zephir_check_call_status();
					ZEPHIR_SINIT_NVAR(_16$$8);
					ZVAL_LONG(&_16$$8, paddingSize);
					ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_11, 134, _17$$8, &_16$$8);
					zephir_check_call_status();
					ZEPHIR_SINIT_NVAR(_16$$8);
			...
			if (paddingType == 3) {
				...
				ZEPHIR_CALL_FUNCTION(&_21$$10, "ord", &_6, 135, last);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, encrypt) {
	...
	ZEPHIR_CALL_FUNCTION(&ivSize, "mcrypt_get_iv_size", NULL, 136, cipher, mode);
	zephir_check_call_status();
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, 2);
	ZEPHIR_CALL_FUNCTION(&iv, "mcrypt_create_iv", NULL, 137, ivSize, &_0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&blockSize, "mcrypt_get_block_size", NULL, 138, cipher, mode);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_5, "mcrypt_encrypt", NULL, 139, cipher, encryptKey, padded, mode, iv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, decrypt) {
	...
	ZEPHIR_CALL_FUNCTION(&decrypted, "mcrypt_decrypt", NULL, 140, cipher, decryptKey, _0, mode, _2);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&blockSize, "mcrypt_get_block_size", NULL, 138, cipher, mode);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(paddingType);
...
PHP_METHOD(Phalcon_Crypt, encryptBase64) {
	...
	if (safe == 1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_2$$3, "base64_encode", &_3, 117, _0$$3);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", &_3, 117, _6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Crypt, decryptBase64) {
	...
	if (safe == 1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_3$$3, "base64_decode", &_4, 118, _2$$3);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "decrypt", &_5, 0, _3$$3, key);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_6, "base64_decode", &_4, 118, text);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, getAvailableCiphers) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mcrypt_list_algorithms", NULL, 141);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Crypt, getAvailableModes) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mcrypt_list_modes", NULL, 142);
	zephir_check_call_status();
	RETURN_MM();
