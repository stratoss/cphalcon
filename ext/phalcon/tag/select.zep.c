...
PHP_METHOD(Phalcon_Tag_Select, selectField) {
	...
	if (Z_TYPE_P(options) == IS_OBJECT) {
		...
		ZEPHIR_CALL_SELF(&_8$$24, "_optionsfromresultset", &_9, 419, options, using, value, _11$$24);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(options) == IS_ARRAY) {
			...
			ZEPHIR_CALL_SELF(&_12$$26, "_optionsfromarray", &_13, 420, options, value, _15$$26);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Tag_Select, _optionsFromArray) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		ZEPHIR_CALL_FUNCTION(&escaped, "htmlspecialchars", &_3, 184, optionValue);
		zephir_check_call_status();
		if (Z_TYPE_P(optionText) == IS_ARRAY) {
			ZEPHIR_INIT_NVAR(_4$$4);
			ZEPHIR_GET_CONSTANT(_4$$4, "PHP_EOL");
			ZEPHIR_CALL_SELF(&_5$$4, "_optionsfromarray", &_6, 420, optionText, value, closeOption);
			zephir_check_call_status();
