...
PHP_METHOD(Phalcon_Security_Random, bytes) {
	...
	if ((zephir_file_exists(&_2 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 287, &_3$$6, &_4$$6);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, hex) {
	...
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(_3);
	ZEPHIR_RETURN_CALL_FUNCTION("array_shift", NULL, 124, _3);
	ZEPHIR_UNREF(_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Security_Random, base64) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "bytes", NULL, 0, _1);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 117, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Security_Random, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 407, &_2, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&ary, "array_values", NULL, 217, _3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, number) {
	...
	ZEPHIR_SINIT_NVAR(_1);
	ZVAL_LONG(&_1, _4);
	ZEPHIR_CALL_FUNCTION(&mask, "ord", &_5, 135, &_1);
	zephir_check_call_status();
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_13$$6, "ord", &_5, 135, _9$$6);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_14$$6);
		zephir_bitwise_and_function(&_14$$6, _13$$6, mask TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_13$$6, "chr", &_15, 133, &_14$$6);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(ret);
	ZEPHIR_CALL_FUNCTION(&_20, "array_shift", NULL, 124, ret);
	ZEPHIR_UNREF(ret);
	zephir_check_call_status();
