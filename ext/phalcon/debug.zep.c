...
PHP_METHOD(Phalcon_Debug, debugVar) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "debug_backtrace", NULL, 154);
	zephir_check_call_status();
	zephir_array_fast_append(_0, _1);
	ZEPHIR_INIT_VAR(_2);
	zephir_time(_2);
...
PHP_METHOD(Phalcon_Debug, _escapeString) {
	...
	if (Z_TYPE_P(value) == IS_STRING) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("htmlentities", NULL, 155, _0$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		if (Z_TYPE_P(v) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_getarraydump", &_8, 156, v, _7$$9);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, _getVarDump) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&_2$$11, this_ptr, "_getarraydump", &_1, 156, variable);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, getMajorVersion) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_version_ce, "get", &_1, 157);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, getVersion) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_1, phalcon_version_ce, "get", &_2, 157);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, showTraceItem) {
	...
	if (zephir_array_isset_string(trace, SS("class"))) {
		...
		if ((zephir_function_exists(functionName TSRMLS_CC)  == SUCCESS)) {
			...
			ZEPHIR_CALL_METHOD(NULL, functionReflection, "__construct", NULL, 159, functionName);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_16$$10, functionReflection, "isinternal", NULL, 160);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&filez, trace, SS("file"), 0 TSRMLS_CC)) {
		...
		if (zephir_is_true(showFiles)) {
			ZEPHIR_CALL_FUNCTION(&lines, "file", NULL, 161, filez);
			zephir_check_call_status();
			...
			while (1) {
				...
				if (_45$$26) {
					...
					ZEPHIR_CALL_FUNCTION(&_51$$31, "htmlentities", &_52, 155, _46$$31, &_49$$31, &_50$$31);
					zephir_check_call_status();
	...
	if (zephir_is_true(showBackTrace)) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_12$$5, &_11$$5)
			...
			ZEPHIR_CALL_METHOD(&_14$$7, this_ptr, "showtraceitem", &_15, 165, n, traceItem);
			zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_17$$5, &_16$$5)
			...
			if (Z_TYPE_P(value) != IS_ARRAY) {
				...
				ZEPHIR_CALL_FUNCTION(&_20$$10, "print_r", &_21, 166, value, ZEPHIR_GLOBAL(global_true));
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_29$$5, "get_included_files", NULL, 167);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_34$$5, "memory_get_usage", NULL, 168, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
