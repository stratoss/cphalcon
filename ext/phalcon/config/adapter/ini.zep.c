...
PHP_METHOD(Phalcon_Config_Adapter_Ini, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&iniConfig, "parse_ini_file", NULL, 129, filePath, ZEPHIR_GLOBAL(global_true));
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, _parseIniString) {
	...
	zephir_create_array(return_value, 1, 0 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "_parseinistring", NULL, 130, path, value);
	zephir_check_call_status();
